...
const LOCALES = {
  en: {
    ...
    screenCaptureConfirm: () => 'A recording of this screen has been requested.\n\nNothing is being recorded yet, and nothing will be until you say so. Turn on Do Not Disturb so a notification cannot appear in the video, then press OK and go back to the terminal where you asked for the evidence — the question is waiting there.\n\nRecording starts when you answer it, and the machine should be left alone until it finishes.',
  },
  ja: {
    label: '日本語',
    ...
    screenCaptureConfirm: () => 'この画面の録画が要求されました。\n\nまだ録画は始まっていませんし、承諾するまで始まりません。通知が映り込まないよう集中モードをオンにしてから OK を押し、証跡を依頼したターミナルに戻ってください。そこに質問が出ています。\n\n答えた時点で録画が始まります。終わるまでこのマシンは操作しないでください。',
  },
  vi: {
    label: 'Tiếng Việt',
    ...
    screenCaptureConfirm: () => 'Có yêu cầu quay màn hình này.\n\nChưa quay gì cả, và sẽ không quay cho tới khi bạn đồng ý. Hãy bật Do Not Disturb để thông báo không lọt vào video, rồi bấm OK và quay lại cửa sổ terminal nơi bạn yêu cầu lấy evidence — câu hỏi đang chờ ở đó.\n\nTrả lời xong là bắt đầu quay, và đừng dùng máy cho tới khi quay xong.',
  },
};

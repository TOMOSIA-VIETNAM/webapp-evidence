...
const LOCALES = {
  en: {
    ...
    screenCaptureConfirm: () => 'A recording of this screen has been requested.\n\nNothing is being recorded yet. Go back to the terminal where you asked for the evidence — there is a question waiting there.',
    screenCaptureStarting: () => 'Recording this screen now.\n\nPlease do not use this machine until it finishes. Turn on Do Not Disturb so a notification cannot appear in the video.',
  },
  ja: {
    label: '日本語',
    ...
    screenCaptureConfirm: () => 'この画面の録画が要求されました。\n\nまだ録画は始まっていません。証跡を依頼したターミナルに戻ってください。そこに確認の質問が出ています。',
    screenCaptureStarting: () => 'これからこの画面を録画します。\n\n終わるまでこのマシンを操作しないでください。通知が映り込まないよう、集中モードをオンにしてください。',
  },
  vi: {
    label: 'Tiếng Việt',
    ...
    screenCaptureConfirm: () => 'Có yêu cầu quay màn hình này.\n\nChưa quay gì cả. Hãy quay lại cửa sổ terminal nơi bạn yêu cầu lấy evidence — ở đó đang có một câu hỏi chờ bạn xác nhận.',
    screenCaptureStarting: () => 'Bắt đầu quay màn hình này.\n\nĐừng dùng máy cho tới khi quay xong. Hãy bật Do Not Disturb để thông báo không lọt vào video.',
  },
};

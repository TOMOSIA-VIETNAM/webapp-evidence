...
#
# Three things land in docs/demo: the gif the README embeds, the vision contact sheets it links,
# and the full-resolution mp4 of the whole tour. The mp4 is too large to commit, so it is left
# untracked for you to upload wherever you need it; the rest is versioned.
...
# stops once the page has been read down to the feature cards. The whole tour is in the mp4.
#
...
node "$REPO/src/skills/vision/scripts/contact-sheet.js" "$MP4" \
